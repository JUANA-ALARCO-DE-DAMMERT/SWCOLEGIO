    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{url('secretaria')}}" method="POST" class="form-horizontal" onsubmit="return Comprobar();"> 
                @method('POST')
                {{ csrf_field() }}
                    @if (count($errors)>0)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input class="form-control" type="date" min="1900-01-01" max="2002-12-31" name="trab_fnac" value="{{old('trab_fnac')}}" required>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input class="form-control" id="telef" type="text"  name="trab_tel" onKeyPress="return soloNumeros(event)" onKeyUp="pierdeFoco(this)" maxlength="9"  required>
                        </div>
                    </div>
