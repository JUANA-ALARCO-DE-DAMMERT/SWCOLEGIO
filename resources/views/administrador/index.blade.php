            	...
            	<table class="table table-responsive-sm table-hover table-sm" id="dataTable">
            		...
            		<tbody>
            			...
            			<tr>
                            ...
                            <td>
                                <a data-toggle="modal" data-target="#modal-info-{{$trab->trab_id}}" title="Info del usuario" class="btn btn-sm btn-info"><i class="fa fa-search"></i></a>      
                                @include('administrador.info')
                                ...
                                @include('administrador.estado')
                                    <a href="{{url('administrador/'.$trab->trab_id.'/edit')}}" title="Editar usuario" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i></a>
                            </td>
            			</tr>
            			@endforeach
            		</tbody>
